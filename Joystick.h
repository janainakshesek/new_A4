...
typedef struct {																													//Definição da estrutura de um controle (!)
	...
	unsigned char down;		
	unsigned char fire;																										//Botão de movimentação para baixo (!)
...
void joystick_fire(joystick *element);																								//Protótipo da função de ativação/desativação do botão de disparo (!)																						//Protótipo da função de ativação/desativação do botão de movimentação para baixo (!)
